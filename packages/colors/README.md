...
```typescript
import { hexToRgb, rgbToHex, lighten, darken } from '@tools/colors';
...
Attempting to import from `@tools/strings` or `@tools/async` will result in a linting error due to module boundary constraints.
