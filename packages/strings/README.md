...
```typescript
import { capitalize, slugify } from '@tools/strings';
...
Attempting to import from `@tools/colors` or `@tools/async` will result in a linting error due to module boundary constraints.
